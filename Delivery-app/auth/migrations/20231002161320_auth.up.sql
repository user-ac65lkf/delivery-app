...
INSERT INTO "users" (name, surname, phone, login, password_hash, role, address, coordinate_address_x, coordinate_address_y) VALUES
    ('Rudy', 'Julian', '555', 'login', 'passw', 'userrole', 'address', 55.66, 667.55),
    ('Tom', 'Bria222stopn', '888', 'login', 'passw', 'userrole', 'address', 55.66, 667.55),
    ('George', 'Bush', '888', 'login', 'passw', 'userrole', 'address', 55.66, 667.55);
